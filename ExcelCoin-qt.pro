###############################################################################################
#ExcelCoin is a modified EverGreenCoin comes from original source of MaiaCoin by Mammix2
###############################################################################################
TEMPLATE = app
TARGET = ExcelCoin-Qt
VERSION = 1.7.3.1
...
macx:ICON = src/qt/res/icons/excelcoin.icns
macx:TARGET = "ExcelCoin-Qt"
