...
static const int64_t MAX_MONEY = 30000000 * COIN; // 30M TOTAL SUPPLY
static const int64_t COIN_YEAR_REWARD = 1 * CENT; // 1% per year
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.08 * COIN;	// 8%
...
public:
    ...
    {
        // excelcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // excelcoin: get transaction coin age
...
public:
    ...
    // excelcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // excelcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // excelcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // excelcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // excelcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // excelcoin: block index flags
    enum  
    {
